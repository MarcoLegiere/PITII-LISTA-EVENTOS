...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('polls', '0013_remove_user_meeting_delete_meeting_delete_owner_and_more'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(blank=True, choices=[('p', 'Presencial'), ('o', 'Online')], default='p', help_text='Local Reunião', max_length=1)),
            ],
        ),
        migrations.CreateModel(
            name='Owner',
